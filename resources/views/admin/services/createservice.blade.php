...
<div class="card uper">
  ...
  <div class="card-body">
    ...
    @endif
      <form id="form" method="post" action="{{ route('services.store') }}" enctype="multipart/form-data">
